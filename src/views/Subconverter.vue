        ...
        <el-card>
          ...
          <el-container>
            <el-form :model="form" label-width="80px" label-position="left" style="width: 100%">
              ...
              <el-form-item label-width="0px" style="text-align: center">
				<a href="https://cdn.jsdelivr.net/gh/limr95/webcdn@1.3/dyzh.apk" style="text-decoration: none; color: #FFFFFF;">
				<el-button
                  style="width: 250px;"
                  type="success"
                  icon="el-icon-download"
                >Android客户端</el-button></a>
              </el-form-item>
            </el-form>
          </el-container>
        </el-card>
...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "自建后端": "https://dyzh.jksaigao.ml/sub?",
          "自建备用后端": "https://houduan.jkloliclub.tk/sub?",
        ...
        backendOptions: [
          { value: "https://dyzh.jksaigao.ml/sub?" }, 
          { value: "https://houduan.jkloliclub.tk/sub?" },    
        ...
        remoteConfig: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "CNIX-Meilieage",
                value: "https://raw.githubusercontent.com/9B6CuV8RgY/Rules/master/Clash/Ruleset/CNIX-Meilieage.ini"
              }
            ]
          }
        ]
  ...
  methods: {
    ...
    .then(() => {
        const youtube = 'https://www.youtube.com/watch?v=linlz7-Pnvw'
        window.open(youtube);
        });
    },
    makeUrl() {
